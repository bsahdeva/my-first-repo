...
class CircleScene(bb.Scene):
    ...
    def construct(self):
        ...
        intro = bb.Tex(r"These circles are described by $r(\theta) = 2a \cdot \sin{(\theta)}$, where $a$ is a constant.",
                          font_size = 40).shift(bb.UP * 3)
        intro_rect = bb.SurroundingRectangle(intro, color = bb.BLACK).set_fill(bb.BLACK, opacity = 1)
        ...
        self.play(bb.Transform(intro_rect, sin_rect4), 
                  ...
                  a3_txt.animate.next_to(nsin_len_brace, direction = bb.DOWN),
                  bb.FadeOut(sin_txt3))
